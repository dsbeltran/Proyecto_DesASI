                    ...
                    <li class="menu-item-has-children dropdown">
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-cogs"></i><a href="<?php echo e(url('/Cliente')); ?>">Ver Clientes</a></li>
                                <li><i class="menu-icon fa fa-table"></i><a href="<?php echo e(url('/Cliente/create')); ?>">Crear Clientes</a></li>                            
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-th"></i><a href="<?php echo e(url('/Empleado')); ?>">Ver Empleados</a></li>
                                <li><i class="menu-icon fa fa-tasks"></i><a href="<?php echo e(url('/Empleado/create')); ?>">Crear Empleado</a></li>                              
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-fort-awesome"></i><a href="<?php echo e(url('Estandar_de_produccion')); ?>">Ver Estandares de produccion</a></li>    
                                <li><i class="menu-icon ti-themify-logo"></i><a href="<?php echo e(url('Estandar_de_produccion/create')); ?>">Crear Estandar de produccion</a></li>                          
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon ti-email"></i><a href="<?php echo e(url('Gerente')); ?>">Ver Gerentes</a></li>
                                <li><i class="menu-icon fa fa-line-chart"></i><a href="<?php echo e(url('Gerente/create')); ?>">Crear Gerente</a></li>                            
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-area-chart"></i><a href="<?php echo e(url('Maquinaria')); ?>">Ver Maquinarias</a></li>
                                <li><i class="menu-icon fa fa-pie-chart"></i><a href="<?php echo e(url('Maquinaria/create')); ?>">Añadir Maquinaria</a></li> 
                            </ul>
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-sign-in"></i><a href="<?php echo e(url('Materia_prima')); ?>">Ver Materia Prima</a></li>   
                                <li><i class="menu-icon fa fa-sign-in"></i><a href="<?php echo e(url('Materia_prima/create')); ?>">Añadir Materia Prima</a></li>                            
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-paper-plane"></i><a href="<?php echo e(url('/Oreden_detrabajo')); ?>">Ver Orden de trabajo</a></li>

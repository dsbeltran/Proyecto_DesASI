...
<p>A continuacion se despiga un reporte donde se encuetra toda la informacion de todas las Oreden de Trabajo con sus respectivas Descripciones registradas</p>
            <table class="table">
                ...
                <tbody>
                @foreach ($Oreden_detrabajodescrips as $Oreden_detrabajodescrips)
                    <tr>
                        <th scope="row">{{$Oreden_detrabajodescrips->odes_id}}</th>
                            <td>{{$Oreden_detrabajodescrips->pro_id}}</td>
                            <td>{{$Oreden_detrabajodescrips->ord_id}}</td>
                            <td>{{$Oreden_detrabajodescrips->odes_desc}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
